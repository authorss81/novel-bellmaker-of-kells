...
| — | 03 (close) | `workspace/volume-03/audit/` | — | — | `state/continuity.md` §10h, `reviews/volume-03/volume-audit.md` | **the volume-close phase, and the ONE next-phase prompt the closing batch left behind. It creates `outline/volume-04.md` and `outline/batches/volume-04-batch-0001.md` and only then `workspace/volume-04/batch-0001/PROMPT.md`** |
| — | 04 | **no phase directory, no outline, no cards — correct at this moment** | 151– | 137– | — | **`PHASE_SYSTEM.md` creates the next volume outline only after the audit passes, so the gap is expected and the audit phase above is what fills it. Do not create the Volume 04 outline in any other phase.** |
