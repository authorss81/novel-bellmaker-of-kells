...
| 0017 | 04 | `workspace/volume-04/batch-0002/` | 161–170 | 147–156 | (to be written) | **THE ONE NEXT PHASE — Chapters 161–170, opening on Day 147** |
| — | 04 (plan) | **`outline/volume-04.md` EXISTS, and `outline/batches/volume-04-batch-0001.md` held the ten cards for Chapters 151–160, which are WRITTEN** | 151–200 | 137–186 | — | **The volume outline was written by the Volume 03 volume-close phase after that audit passed, as `PHASE_SYSTEM.md` requires. There is no `outline/batches/volume-04-batch-0002.md` and none may be created until the batch that earns it, and there is no volume-close prompt and none may be created.** |
