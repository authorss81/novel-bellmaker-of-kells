...
| 0016 | 04 | `workspace/volume-04/batch-0001/` | 151–160 | 137–146 | `state/batch-0016-summary.md` (to be written) | **THE ONE NEXT PHASE — Chapters 151–160, opening on Day 137** |
| — | 04 (plan) | **`outline/volume-04.md` EXISTS and `outline/batches/volume-04-batch-0001.md` holds the ten cards** | 151–200 | 137–186 | — | **written by the volume-close phase, after the audit passed, as `PHASE_SYSTEM.md` requires. Do not create a Volume 04 batch 0002 directory or any other phase file until the batch that earns it.** |
